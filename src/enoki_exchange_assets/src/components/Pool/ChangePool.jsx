...
import {createActor as createActorToken} from "../../../../declarations/enoki_wrapped_token";
import {useSelector} from "react-redux";
import getPoolWorker from "../../actors/getPoolWorker";
import {bigIntToFloat, bigIntToStr, floatToBigInt} from "../../utils/utils";
...
const getTokenBalances = async identity => {
  ...
  let [balance_a, balance_b] = await Promise.all([
    createActorToken(canisterIdA).balanceOf(principal),
    createActorToken(canisterIdB).balanceOf(principal)
  ]);
